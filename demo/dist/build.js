                    ...
                    computed: {
                        enumList: function() {
                            ...
                            return Array.isArray(this.list) && this.list.length > 0 ? this.list.forEach(function(item) {
                                "object" === (void 0 === item ? "undefined" : _typeof(item)) && void 0 !== item.id ? tmp.push(item) : console.warn("not correct item ", item);
